export const post = {
    ...
    body: String.raw`Note :Imported from [medium](https://gmongaras.medium.com/coding-a-virtual-ai-girlfriend-f951e648aa46)
...
![I have no money](/blogs/images/ai_girlfriend/1.webp)
...
![First visualization](/blogs/images/ai_girlfriend/2.webp "Why hello there")
...
[https://github.com/pkhungurn/talking-head-anime-demo](https://github.com/pkhungurn/talking-head-anime-demo)
...
![Blinking](/blogs/images/ai_girlfriend/3.webp)
...
![EMWA formula?](/blogs/images/ai_girlfriend/7.webp)

The EWMA at time *t* takes into account all previous generation time and the current generation time at time $t$. For $\alpha$, I am going to use the value of 0.5, giving equal weight to the previous weighted average and current value.
...
![Generation speed formula?](/blogs/images/ai_girlfriend/8.webp)
