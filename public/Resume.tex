...
\begin{center}
    ...
    \begin{tabular}{r l}
        ...
        \href{mailto:gmongaras@smu.edu}{gmongaras@smu.edu} \quad & $\bullet$ \quad \href{https://gmongaras.me/}{gmongaras.me} \\
...
\vspace{5pt}
\noindent\textbf{Austin Community College - \textbf{3.9 GPA}} \hfill Austin, TX \\
...
Masters Thesis, Senior Thesis, Graduate Quantum Computing, Graduate Artificial Intelligence, Graduate Machine Learning 2, Graduate Algorithm Engineering, Assembly Programming, Algorithms, Calculus I, II \& III, Graduate OS and System Software, Digital Logic Design, Linear Algebra, Digital History, Discrete Computational Structures, Applied Statistics, Engineering Design, Math Modeling, Math of ML, Applied Machine Learning, Data Structures
...
\noindent\textbf{AI:} Neural Networks, Generative models, PyTorch, Machine Learning, Reinforcement Learning, NumPy, CNNs, Transformers, GANs, NEAT, Diffusion Models, Object Detection, Audio Processing, Huggingface, TensorFlow, JAX, OpenAI, GPT, LoRA, finetuning, pretraining, LLM, inference, Claude, Cursor, Gemini, RAG, RLVR, RLHF
...
\noindent\textbf{Magic}, \textit{MTS}, San Francisco, CA \hfill January 2026-Present
\begin{itemize}[noitemsep,topsep=0pt]
  \item Building, improving, and researching ML models.
  \item Built several tests and developed CI to ensure our models are working well and correctly.
  \item Working on large scale RL.
\end{itemize}

\noindent\textbf{Etched}, \textit{Software Engineer}, San Jose, CA \hfill June 2025-January 2026
\begin{itemize}[noitemsep,topsep=0pt]
  \item Coding in Rust, working on a preproduction Rust codebase that will be used on Sohu, an ASIC for running transformers faster than GPUs.
  \item Worked on building infrastructure and implementing various manufacturing level tests for the Sohu rack.
\end{itemize}
...
\noindent\textbf{2Mamba2Furious: Linear in Complexity, Competitive in Accuracy}
\begin{itemize}[noitemsep,topsep=0pt]
  \item Ablated what actually makes Mamba2 work in practice, which was not done in the original paper.
  \item Developed a minimal Mamba2 implementation, as good as the original. Then significantly improved the architecture resulting in a linear model that is nearly as good as softmax attention in accuracy and better for long context usage.
  \item Developed a quadratic form of our method that beats softmax attention in accuracy.
  \item Code found here: \href{https://github.com/gmongaras/2Mamba2Furious}{github.com/gmongaras/2Mamba2Furious}
  \item Paper found here: \href{https://arxiv.org/abs/2602.17363}{arxiv.org/abs/2602.17363}
\end{itemize}
...
\begin{itemize}[noitemsep,topsep=0pt]
  ...
  \item Published in TMLR \href{https://openreview.net/forum?id=PHcITOi3vV}{openreview.net/forum?id=PHcITOi3vV}
\end{itemize}
...
\begin{itemize}[noitemsep,topsep=0pt]
  ...
  \item Published in Springer Nature \href{https://link.springer.com/chapter/10.1007/978-3-031-92602-0_32}{link.springer.com/book/10.1007/978-3-031-92602-0}
\end{itemize}
...
\begin{itemize}[noitemsep,topsep=0pt]
  ...
  \item \href{https://gmongaras.me/#blog/diffusion-models}{gmongaras.me/\#blog/diffusion-models}
\end{itemize}
...
\begin{itemize}[noitemsep,topsep=0pt]
  ...
  \item Code, results, models, and data found at \href{https://github.com/gmongaras/Stable-Diffusion-3-From-Scratch}{github.com/gmongaras/Stable-Diffusion-3-From-Scratch}
\end{itemize}
...
\noindent\textbf{GRPO DAPO Tests} \hfill Summer 2022
\begin{itemize}[noitemsep,topsep=0pt]
  \item RLHFed a llama model to make it answer questions.
  \item Looked into both GRPO and DAPO, which were SoTA, to do the finetuning. Built these methods from scratch.
  \item \href{https://github.com/gmongaras/GRPO-DAPO-Tests}{github.com/gmongaras/GRPO-DAPO-Tests}
\end{itemize}
...
%   \item \href{https://gmongaras.me/#blog/ai-girlfriend}{https://gmongaras.me/\#blog/ai-girlfriend}
% \end{itemize}
...
%   \item \href{https://gmongaras.me/#blog/attn-masks}{https://gmongaras.me/\#blog/attn-masks}
% \end{itemize}
\vspace{-5pt}
\begin{tabbing}
